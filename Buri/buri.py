...
from Buri.utils import cmd, show
from Buri.core import Core
...
class Buri:
    ...
    def __init__(self, directory: str, interpreters: str = 'python3,py3,py,python'):
        ...
        show(self.core.log, 'Finished instantiating Buri.\n')
        self._ip = ""
        self._token = ""
        self._api_url = ""
    ...
    def requester(self, url: str, request_type: str = 'get', kwargs: str = "{}") -> str:
        ...
        Script is implemented separately as to avoid adding it's requirements to Buri.
